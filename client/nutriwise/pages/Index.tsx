...
const heroImage = "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=1200&q=80&auto=format&fit=crop";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight text-foreground">
                Plan Smart. Eat Better. <span className="text-primary">Stay on Budget</span> with NutriWise.
              </h1>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Link to="/app/budget" className="flex-1">
